...
// request & response
import { IssucceedInfomation, Customerlist } from '../admin/models/ResponseEntities';
import { CustomerPayload, CustomerEditPayload } from '../admin/models/RequestEntities';
